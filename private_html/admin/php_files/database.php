...
class Database{
		...
		private $db_user = "newbasan_Flower_db";       // Change as required
		private $db_pass = "nAy4aGzrrxQXgeegcMTb";   // Change as required
		private $db_name = "newbasan_Flower_db";   // Change as required
