            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(res.hasOwnProperty('success')){
                        ...
                        setTimeout(function(){ window.location = URL+'products.php'; }, 1000);
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(res.hasOwnProperty('success')){
                        ...
                        setTimeout(function(){ window.location = URL+'category.php'; }, 1000);
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(res.hasOwnProperty('success')){
                        ...
                        setTimeout(function(){ window.location = URL+'sub_category.php'; }, 1000);
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(res.hasOwnProperty('success')){
                        ...
                        setTimeout(function(){ window.location = URL+'brands.php'; }, 1000);
