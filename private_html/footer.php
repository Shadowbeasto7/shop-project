<div id ="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <span><?php echo $footer[0]['footer_text'] ?> | Created by <a href="https://www.newbasantanursery.com" target="_blank">NewBasantaNursery</a></span>
            </div>
        </div>
    </div>
...
<!-- scroll top button -->   <!-- scroll top button --> 
    <a href="#top" class="scroll-top fas fa-angle-up"></a> 
...
<script src="js/scripto1.js"></script>
<!--okzoom Plugin-->
